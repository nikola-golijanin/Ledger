...
public static class ChartOfAccountsSeeder
{
    ...
    [
        ...
        new() { Number = AccountNumbers.SuspenseDepositInflight, Code = "suspense.deposit.inflight", Name = "Suspense – Deposit In-flight", Type = AccountType.Asset },
        ...
        new() { Number = AccountNumbers.SuspenseDepositReview,   Code = "suspense.deposit.review",  Name = "Suspense – Deposit Review",  Type = AccountType.Liability },
        new() { Number = AccountNumbers.SuspenseBounce,          Code = "suspense.bounce",          Name = "Suspense – Bounce",          Type = AccountType.Liability }
    ];
